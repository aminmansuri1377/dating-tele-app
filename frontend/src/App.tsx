...
export default function App() {
  ...
  if (booting) {
    return (
      <div className="h-screen flex items-center justify-center text-brand">
        Loading…
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen pt-16 bg-surface-light dark:bg-surface-dark text-black dark:text-white">
      {" "}
      <Routes>
